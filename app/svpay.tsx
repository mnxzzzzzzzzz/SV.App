  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <Pressable
            style={[styles.merchantCard, selectedMerchant === item.id && styles.merchantCardSelected]}
            onPress={() => setSelectedMerchant(selectedMerchant === item.id ? null : item.id)}
          >
            <View style={styles.merchantHeader}>
              ...
              {item.alreadyUsed && <Text style={styles.usedBadge}>✓ Used today</Text>}
            </View>
            ...
            {!item.alreadyUsed && (
              <Pressable style={styles.tapButton} onPress={() => handleTapToPay(item.id, item.name)}>
                <Text style={styles.tapButtonText}>📱 Tap phone to pay</Text>
              </Pressable>
            )}

            {item.alreadyUsed && (
              <Pressable style={styles.fallbackButton} onPress={() => router.push("/qr")}>
      ...
      <View style={styles.infoSection}>
        ...
        <View style={styles.fallbackWarning}>
          <Text style={styles.warningText}>⚠️ Already used today? Try QR redemption for other merchants</Text>
        </View>
      </View>
