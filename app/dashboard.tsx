      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.progressSection}>
          <Text style={styles.progressTitle}>
            🎯 {friendsReferred}/{totalNeeded} Friends Referred
          </Text>
          ...
          <Text style={styles.rewardText}>🏆 Reward: 1 Month Pro (Value: AED 25)</Text>
        </View>
        ...
        <View style={styles.referralsSection}>
          ...
          {referrals.length > 0 ? (
            ...
            <Text style={styles.noReferralsText}>You haven't referred anyone yet. Share your link to get started!</Text>
          )}
        </View>
        ...
        <View style={styles.bonusSection}>
          ...
          <Text style={styles.bonusText}>• Every 5 successful referrals = 1 Month Free Pro</Text>
          <Text style={styles.bonusText}>• Share your SV Clips for bonus Verse Points</Text>
          <Text style={styles.bonusText}>• Top referrer each month wins exclusive rewards!</Text>
        </View>
      </ScrollView>
