        ...
        >
          ...
          <View style={styles.taglineSection}>
            ...
            <Text style={styles.taglineSub}>
              I'll plan the night — with discounts
            </Text>
          </View>
          ...
          {plans.map((plan) => (
            ...
            >
              <Text
                style={[
                  styles.planTabText,
                  selectedPlan === plan.id && styles.planTabTextActive,
                ]}
              >
                {plan.title}
              </Text>
                ...
                {plan.items.map((item, index) => (
                  <View key={index} style={styles.itineraryItem}>
                    ...
                    <View style={styles.itineraryRight}>
                      <Text style={styles.itinerantMerchantName}>
                        {item.merchant.name}
                      </Text>
                      <Text style={styles.itinerantOffer}>
                        {item.merchant.offer}
                      </Text>

                      <Pressable
                        style={styles.redeemButton}
                        onPress={() => handleRedeem(item.merchant.id)}
                      >
